...
var app = express();
var new_db = "mongodb://localhost:27017/loninform";
...
// perform HMAC operation on the password and also using phone number of the user as the key
...
app.post('/sign_up',function(req,res){
    ...
    mongo.connect(new_db,function(err,res){
        if(err){
        throw err; 
        }
